...
.directive('wframe', ['$compile', '$timeout', function($compile, $timeout) {
...
.directive('colorsGrid', ['$compile', '$document', function($compile, $document) {
  var linker = function( scope, element, attrs, ctrl ) {
    //click away
...
.directive('wysiwygEdit', ['$compile', '$timeout',  function($compile, $timeout) {
  var linker = function( scope, $element, attrs, ctrl ) {
  ...
  return {
    ...
    restrict: 'AE',
    replace: true,
    templateUrl: '/templates/plugins/wysiwyg.html'
  };
}]);